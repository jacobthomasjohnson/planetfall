      ...
      return (
            <div className="h-full">
                  <div className="flex flex-col">
                        <Header ref={headerRef} toggle={toggleMenu} />
                        <Menu
                              menuTop={menuTop}
                              menuOpen={menuOpen}
                  ...
                  <PlanetDetails currentPlanet={currentPlanet} togglePlanetDetails={togglePlanetDetails} planetDetailsOpen={planetDetailsOpen} />
            </div>
      );
}
